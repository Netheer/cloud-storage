...
export class S3ObjectStorageService
  implements ObjectStorage, OnModuleDestroy
{
  ...
  constructor(configService: ConfigService) {
    ...
    const useSsl =
      configService.getOrThrow<string>('MINIO_USE_SSL') ===
      'true';
    ...
    this.bucket =
      configService.getOrThrow<string>('MINIO_BUCKET');
    ...
    this.client = new S3Client({
      ...
      credentials: {
        accessKeyId:
          configService.getOrThrow<string>('MINIO_ROOT_USER'),
